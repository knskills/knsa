...
// https://www.privacypolicygenerator.info/live.php?token=OPg3d1uwKKeGn4pWml5qukhWc5PlggE0
  ...
  return (
    <>
      <div className="PrivacyPolicy-container">
        ...
        <div className="PrivacyPolicy-cont-flex">
          <div className="PrivacyPolicy-cont-card">
            <h1>Privacy Policy for knla</h1>

            <p>
              At knla, accessible from www.knla.in, one of our main priorities
              is the privacy of our visitors. This Privacy Policy document
              contains types of information that is collected and recorded by
              knla and how we use it.
            </p>
            ...
            <p>
              ...
              that they shared and/or collect in knla. This policy is not
            ...
            <ul>
              <li>
                {" "}
                <i className="fa-regular fa-circle-dot"></i> Provide, operate,
                and maintain our website
              </li>
              <li>
                {" "}
                <i className="fa-regular fa-circle-dot"></i> Improve,
                personalize, and expand our website
              </li>
              <li>
                {" "}
                <i className="fa-regular fa-circle-dot"></i> Understand and
              ...
              <li>
                {" "}
                <i className="fa-regular fa-circle-dot"></i> Send you emails
              </li>
              <li>
                {" "}
                <i className="fa-regular fa-circle-dot"></i> Find and prevent
                fraud
              </li>
            </ul>
            ...
            <p>
              knla follows a standard procedure of using log files. These files
            ...
            <p>
              Like any other website, knla uses "cookies". These cookies are
            ...
            {/* <ul>
            <li> <i className="fa-regular fa-circle-dot"></i> 
              <p>Google</p>
              <p>
                <a href="https://policies.google.com/technologies/ads">
                  https://policies.google.com/technologies/ads
            ...
            <p>
              ...
              the advertising partners of knla.
            </p>

            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on knla, which are
            ...
            <p>
              Note that knla has no access to or control over these cookies that
            ...
            <p>
              knla's Privacy Policy does not apply to other advertisers or
            ...
            <p>
              knla does not knowingly collect any Personal Identifiable
