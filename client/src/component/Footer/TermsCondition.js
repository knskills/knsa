...
// https://www.termsandconditionsgenerator.com/live.php?token=16eChI2SLlCDpZRjczBoSZ0qkKLWUTVZ
    ...
    <>
      <div className="TermsCondition-container">
        <div className="con-ab-nav">
          <Link to="/">HOME</Link> | <Link to="">TERSM & CONDITION</Link>
        </div>
        <div className="TermsCondition-cont-flex">
          <div className="TermsCondition-cont-card">
            <h1>
            ...
            <p>
              ...
              the use of knla's Website, located at www.knla.in.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use knla if you do not agree to
            ...
            <p>
              We employ the use of cookies. By accessing knla, you agreed to use
              cookies in agreement with the knla's Privacy Policy.
            </p>
            ...
            <p>
              Unless otherwise stated, knla and/or its licensors own the
              intellectual property rights for all material on knla. All
              intellectual property rights are reserved. You may access this
              from knla for your own personal use subjected to restrictions set
              in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from knla</li>
              <li>Sell, rent or sub-license material from knla</li>
              <li>Reproduce, duplicate or copy material from knla</li>
              <li>Redistribute content from knla</li>
            </ul>
            ...
            <p>
              ...
              knla does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views
              and opinions of knla,its agents and/or affiliates. Comments
              reflect the views and opinions of the person who post their views
              and opinions. To the extent permitted by applicable laws, knla
            ...
            <p>
              knla reserves the right to monitor all Comments and to remove any
            ...
            <p>
              You hereby grant knla a non-exclusive license to use, reproduce,
            ...
            <p>
              ...
              knla; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to knla. Please include your name, your
            ...
            <p>
              No use of knla's logo or other artwork will be allowed for linking
