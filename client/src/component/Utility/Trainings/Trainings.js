// here i can filte of all kinds of traings using filter option like check box radiobox select kinds many category.
...
const Trainings = () => {
  ...
  return (
    <>
      <div className="trainings-filter-container">
        <div className="trainings-filter-flex">
          <div className="webinar-container">
            ...
            {/* <div className="webinar-flex-card">
              <div className="upcomings-card-data"> */}
            <div className="training-container">
              <div className="training-flex d-flex">
                {items && items.length > 0
                      ...
                      return (
                        ...
                        >
                          <div className="img-tag">
                            <Link
                              to={`/trainings/single_trainings/${dataItem?._id}`}
                            >
                              <img
                  ...
                  : "Not Uploaded Traings yet... Your patience is highly appreciated!"}
              </div>
            </div>
            {/* </div>
            </div> */}
